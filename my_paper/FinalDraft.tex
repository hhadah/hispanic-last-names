...
%\begin{center}
%\href{https://hussainhadah.com/worksinprogress/hispanicdiscrimnation/}{\textcolor{green!15!black!30!blue}{\footnotesize{\textsc{Click Here to Get the Most Updated Version}}}}
%\end{center}
...
\input{tables/tab03-summary-stats}
...
% $WH_{i}$ &  & -0.088{*}{*}{*} &  & -0.044{*}{*}{*} & \tabularnewline
%  &  & (0.018) &  & (0.017) & \tabularnewline
%  &  &  &  &  & \tabularnewline
% $HW_{i}$ &  & -0.141{*}{*}{*} &  & -0.059{*}{*}{*} & \tabularnewline
%  &  & (0.015) &  & (0.014) & \tabularnewline
%  &  &  &  &  & \tabularnewline
% $HH_{i}$ &  & -0.161{*}{*}{*} &  & -0.058{*}{*}{*} & \tabularnewline
%  &  & (0.008) &  & (0.007) & \tabularnewline
%  &  &  &  &  & \tabularnewline
% \midrule
% $HW_{i}$ - $WH_{i}$ &  & -0.053{*}{*} &  & -0.016 & \tabularnewline
...
% \hline 
%  &  &  &  &  & \tabularnewline
% $WH_{i}\times Hispanic_{i}$ &  & -0.134{*}{*} &  & -0.064 & \tabularnewline
%  &  & (0.053) &  & (0.049) & \tabularnewline
% $HW_{i}\times Hispanic_{i}$ &  & -0.164{*}{*}{*} &  & -0.108{*}{*} & \tabularnewline
%  &  & (0.052) &  & (0.048) & \tabularnewline
% $HH_{i}\times Hispanic_{i}$ &  & -0.106{*}{*} &  & -0.062 & \tabularnewline
%  &  & (0.049) &  & (0.045) & \tabularnewline
% $WH_{i}$ &  & 0.027 &  & 0.011 & \tabularnewline
%  &  & (0.048) &  & (0.045) & \tabularnewline
% $HW_{i}$ &  & 0.007 &  & 0.038 & \tabularnewline
%  &  & (0.050) &  & (0.046) & \tabularnewline
% $HH_{i}$ &  & -0.057 &  & 0.003 & \tabularnewline
%  &  & (0.057) &  & (0.044) & \tabularnewline
% \hline 
% $HW_{i}\times Hispanic_{i}$ - $WH_{i}\times Hispanic_{i}$ &  & -0.030 &  & -0.043 & \tabularnewline
...
%    \item [\textit{Notes.}] The four groups stand for White Husband White Wife (WW), White Husband Hispanic Wife (WH), Hispanic Husband White (HW), and Hispanic Husband Hispanic Wife (HH). $Hispanic_{i}$ is a dummy variable equal to one if a person identifies as Hispanic and zero otherwise.
%    \item [\textit{Notes.}] The sample is restricted to men working full-time full-year and are waged and salaried workers.
...
% Variables &  & Log annual earnings &  & Log annual earnings & \tabularnewline
% \hline 
% $Hispanic_{i}$ &  & -0.156{*}{*}{*} &  & -0.060{*}{*}{*} & \tabularnewline
...
%    \item [\textit{Notes.}] $Hispanic_{i}$ is a dummy variable equal to one if a person identifies as Hispanic and zero otherwise.
%    \item [\textit{Notes.}] The sample is restricted to men working full time full-year and are waged and salaried workers.
%     \item [\textit{Notes.}] Column one has the regression results when controlling for hours worked, age, and fixed effects. Column two has the results after controlling for education.
%   \end{tablenotes}
%   \end{threeparttable}
